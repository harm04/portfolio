                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      //if it is mobile use mediaQuery to adjust the size of card

                      GestureDetector(
                        onTap: (){
                          Utils().showMyDialoug(context, MediaQuery.of(context).size.height * 0.67, MediaQuery.of(context).size.width * 0.9,);
                        },
                        child: Utils().card()),
                      const SizedBox(
                        height: 30,
